...
<code-example path="inputs-outputs/src/app/input-output/input-output.component.ts" region="input-output" header="src/app/item-output/item-output.component.ts" linenums="false">
</code-example>
